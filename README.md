...
Primero deben instalarse los complementos de Angular e Ionic en el editor de código que se utilice para poder hacer andar el proyecto (en este caso se utilizó Visual Studio Code). Luego, se debe cambiar la IP de la máquina (local) donde se está corriendo el proyecto en el archivo *dam-docker/src/backend/mysql-connector.js* en la línea 5, donde dice *host*.
